/*
 * File: app/view/custom/ListGrid.js
 *
...
Ext.define('test.view.custom.ListGrid', {
    ...
    priv_defaultRenderer: function(value) {
    ...
    priv_updateItemTpl: function(newTpl) {
    ...
    priv_buildTpl: function(columns, header) {
